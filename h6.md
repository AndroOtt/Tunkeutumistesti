...
Käynnistin wiresharkin uudestaan (tässä vaiheessa tajusin, että olin wiresharkilla kuunnellut väärää yhteyttä) ja käyin capture methodina "any", sain tuorreet capturet ja siitä selvisi yhteys nopeammin.
